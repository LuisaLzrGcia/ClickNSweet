...
export function renderDashboardProducts(productsArray) {
  ...
  //   html += `
  // <div class="col-12">
  //   <div class="card shadow-sm p-3 border-0 rounded-4 h-100 product-card${inactiveClass}">
  ...
  //               <input class="form-check-input custom-switch" type="checkbox" id="toggle-${product.id}" checked 
  //                     style="width: 2.5em; height: 1.3em;">
  //               <label class="form-check-label small ms-2 switch-state-text" for="toggle-${product.id}"></label>
  //             </div>
  //           </div>
  ...
  // `;
    ...
    <div class="card shadow-sm p-3 border-0 rounded-4 h-100 product-card">
        <div class="row g-3 align-items-center h-100">
            <!-- Sección de imagen -->
            <div class="col-md-4 ${inactiveClass}">
                <div class="position-relative h-100">
